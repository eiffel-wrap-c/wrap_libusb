...
feature -- Access: Routine 
	...
	routine_1: detachable FUNCTION [TUPLE [a_ctx: POINTER; a_device: POINTER; a_event: INTEGER; a_user_data: POINTER], INTEGER] 
			--Eiffel routine to be call on callback.

	routine_2: detachable FUNCTION [TUPLE [a_ctx: POINTER; a_device: POINTER; a_event: INTEGER; a_user_data: POINTER], INTEGER] 
			--Eiffel routine to be call on callback.

	routine_3: detachable FUNCTION [TUPLE [a_ctx: POINTER; a_device: POINTER; a_event: INTEGER; a_user_data: POINTER], INTEGER] 
			--Eiffel routine to be call on callback.
	...
	on_callback_1 (a_ctx: POINTER; a_device: POINTER; a_event: INTEGER; a_user_data: POINTER): INTEGER  
		...
		do
			if attached routine_1 as l_routine then 
				Result :=  l_routine (a_ctx, a_device, a_event, a_user_data)
			end
		end
