...
feature -- Access: Routine 
	...
	routine_1: detachable PROCEDURE [TUPLE [a_fd: INTEGER; a_events: INTEGER; a_user_data: POINTER]] 
			--Eiffel routine to be call on callback.

	routine_2: detachable PROCEDURE [TUPLE [a_fd: INTEGER; a_events: INTEGER; a_user_data: POINTER]] 
			--Eiffel routine to be call on callback.

	routine_3: detachable PROCEDURE [TUPLE [a_fd: INTEGER; a_events: INTEGER; a_user_data: POINTER]] 
			--Eiffel routine to be call on callback.
	...
	on_callback_1 (a_fd: INTEGER; a_events: INTEGER; a_user_data: POINTER)  
		...
		do
			if attached routine_1 as l_routine then 
				l_routine (a_fd, a_events, a_user_data)
			end
		end
