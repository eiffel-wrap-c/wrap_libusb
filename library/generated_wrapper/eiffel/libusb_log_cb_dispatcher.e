...
feature -- Access: Routine 
	...
	routine_1: detachable PROCEDURE [TUPLE [a_ctx: POINTER; a_level: INTEGER; a_str: POINTER]] 
			--Eiffel routine to be call on callback.

	routine_2: detachable PROCEDURE [TUPLE [a_ctx: POINTER; a_level: INTEGER; a_str: POINTER]] 
			--Eiffel routine to be call on callback.

	routine_3: detachable PROCEDURE [TUPLE [a_ctx: POINTER; a_level: INTEGER; a_str: POINTER]] 
			--Eiffel routine to be call on callback.
