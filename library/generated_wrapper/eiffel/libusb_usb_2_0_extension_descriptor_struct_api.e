...
class LIBUSB_USB_2_0_EXTENSION_DESCRIPTOR_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct libusb_usb_2_0_extension_descriptor

	sizeof_external: INTEGER 
		external
			"C inline use <libusb.h>"
		alias
			"sizeof(struct libusb_usb_2_0_extension_descriptor)"
		end
	...
	c_blength (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bLength
			]"
		end
	...
	set_c_blength (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bLength =  (uint8_t)$a_value
			]"
		ensure
	...
	c_bdescriptortype (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bDescriptorType
			]"
		end
	...
	set_c_bdescriptortype (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bDescriptorType =  (uint8_t)$a_value
			]"
		ensure
	...
	c_bdevcapabilitytype (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bDevCapabilityType
			]"
		end
	...
	set_c_bdevcapabilitytype (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bDevCapabilityType =  (uint8_t)$a_value
			]"
		ensure
	...
	c_bmattributes (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bmAttributes
			]"
		end
	...
	set_c_bmattributes (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_usb_2_0_extension_descriptor*)$an_item)->bmAttributes =  (uint32_t)$a_value
			]"
		ensure
