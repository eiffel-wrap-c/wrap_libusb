...
class LIBUSB_BOS_DEV_CAPABILITY_DESCRIPTOR_STRUCT_API
...
feature {ANY} -- Member Access
	...
	dev_capability_data: POINTER
			-- Access member `dev_capability_data`
		require
			exists: exists
		do
			Result := c_dev_capability_data (item)
		ensure
			result_correct: Result = c_dev_capability_data (item)
		end

feature {NONE} -- Implementation wrapper for struct struct libusb_bos_dev_capability_descriptor
	...
	c_blength (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->bLength
			]"
		end
	...
	set_c_blength (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->bLength =  (uint8_t)$a_value
			]"
		ensure
	...
	c_bdescriptortype (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->bDescriptorType
			]"
		end
	...
	set_c_bdescriptortype (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->bDescriptorType =  (uint8_t)$a_value
			]"
		ensure
	...
	c_bdevcapabilitytype (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->bDevCapabilityType
			]"
		end
	...
	set_c_bdevcapabilitytype (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->bDevCapabilityType =  (uint8_t)$a_value
			]"
		ensure
			bdevcapabilitytype_set: a_value = c_bdevcapabilitytype (an_item)
		end

	c_dev_capability_data (an_item: POINTER): POINTER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <libusb.h>"
		alias
			"[
				((struct libusb_bos_dev_capability_descriptor*)$an_item)->dev_capability_data
			]"
		end
